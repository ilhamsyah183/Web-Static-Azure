...
<body>
    <div id="container">
        ...
        <div id="highlight-menu">
                <center>
                    <table cellpacing="0" border="2" style="border-radius: 6;">
                        <a href="isiartikel.php">
                        <h4>7 Makanan Pembentuk Otot Untuk Membentuk Badan Ideal</h4>
                        </a>
                        <tr>
                            <td>
                                <img src="image/sehat.jpg" width="350px" height="250px">
                            </td>
                            <td>
                                <p>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. <br>
                                    Voluptatem, inventore adipisci labore <br>quae similique qui doloremque vero mollitia,<br> 
                                    quidem sequi unde ullam dolorem vitae <br>repudiandae culpa? Vel animi sit accusantium!<br>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit.<br>
                                    Voluptatem, inventore adipisci labore quae<br> similique qui doloremque vero mollitia,<br> 
                                    quidem sequi unde ullam dolorem vitae repud<br>iandae culpa? Vel animi sit accusantium!
                                </p>
                            </td>
                        </tr>
                    </table>
