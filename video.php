    ...
    <div id="container">
        ...
        <div id="content">
            <div class="container-fluid">
                <div class="row baris-menu row-video">
                    <div class="col-sm-12 text-center">
                        <video width="640" height="360" controls>
                            <source src="video/video_gym.mp4" type="video/mp4">
                ...
                <div class="row baris-menu row-video">
                    <div class="col-sm-4">
                        <a href="#">
                            <img class="thumb" src="image/thum-1.jpg" width="90%" height="90%" alt="">
                        </a>
                    </div>
                    <div class="col-sm-8">
                        <h3><b>Melatih Otot Dirumah Aja</b></h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem nihil perspiciatis dignissimos molestiae error exercitationem iusto mollitia veniam hic. Incidunt impedit blanditiis laborum porro fugiat cumque iste doloremque quia dolores!</p>
                    </div>
                </div>
                <div class="row baris-menu row-video">
                    <div class="col-sm-4">
                        <a href="#">
                            <img class="thumb" src="image/thum-2.jpg" width="90%" height="90%" alt="">
                        </a>
                    </div>
                    <div class="col-sm-8">
                        <h3><b>Senam Kebugaran Dirumah Aja</b></h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem nihil perspiciatis dignissimos molestiae error exercitationem iusto mollitia veniam hic. Incidunt impedit blanditiis laborum porro fugiat cumque iste doloremque quia dolores!</p>
                    </div>
                </div>
                <div class="row baris-menu row-video">
